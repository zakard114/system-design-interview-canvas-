  ...
  head: () => ({
    meta: [
      ...
      { title: "Interview Canvas — Shared System Design Board" },
      {
        name: "description",
        content:
          "Run system design interviews on a shared canvas: components, arrows, sticky notes and freehand sketching, synced live.",
      },
      { property: "og:title", content: "Interview Canvas" },
      {
        property: "og:description",
        content: "A shared system design canvas for live technical interviews.",
      },
